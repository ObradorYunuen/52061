...
const serializedATN = [4,1,10,42,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,
...
10,0,1,1,0,4,6,35,0,12,1,0,0,0,2,23,1,0,0,0,4,29,1,0,0,0,6,33,1,0,0,0,8,
35,1,0,0,0,10,37,1,0,0,0,12,13,3,2,1,0,13,14,3,4,2,0,14,15,5,1,0,0,15,16,
3,4,2,0,16,17,3,6,3,0,17,18,5,2,0,0,18,19,3,8,4,0,19,20,5,2,0,0,20,21,5,
3,0,0,21,22,3,10,5,0,22,1,1,0,0,0,23,24,5,8,0,0,24,25,5,8,0,0,25,26,5,9,
0,0,26,27,5,9,0,0,27,28,5,9,0,0,28,3,1,0,0,0,29,30,5,8,0,0,30,31,5,8,0,0,
31,32,5,8,0,0,32,5,1,0,0,0,33,34,5,7,0,0,34,7,1,0,0,0,35,36,7,0,0,0,36,9,
1,0,0,0,37,38,5,8,0,0,38,39,5,9,0,0,39,40,5,9,0,0,40,11,1,0,0,0,0];
...
export default class FlightParser extends antlr4.Parser {
	...
	codigo_vuelo() {
	    ...
	    this.enterRule(localctx, 2, FlightParser.RULE_codigo_vuelo);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 23;
	...
	aeropuerto() {
	    ...
	    this.enterRule(localctx, 4, FlightParser.RULE_aeropuerto);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 29;
	        this.match(FlightParser.LETRA);
	...
	puerta() {
	    ...
	    this.enterRule(localctx, 10, FlightParser.RULE_puerta);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 37;
	        this.match(FlightParser.LETRA);
...
FlightParser.T__1 = 2;
FlightParser.T__2 = 3;
FlightParser.ON_TIME = 4;
FlightParser.DELAYED = 5;
FlightParser.CANCELLED = 6;
FlightParser.HORA = 7;
FlightParser.LETRA = 8;
FlightParser.DIGITO = 9;
FlightParser.WS = 10;

FlightParser.RULE_vuelo = 0;
FlightParser.RULE_codigo_vuelo = 1;
FlightParser.RULE_aeropuerto = 2;
FlightParser.RULE_hora = 3;
FlightParser.RULE_estado = 4;
FlightParser.RULE_puerta = 5;
...
class AeropuertoContext extends antlr4.ParserRuleContext {
    ...
    constructor(parser, parent, invokingState) {
        ...
        super(parent, invokingState);
        this.parser = parser;
        this.ruleIndex = FlightParser.RULE_aeropuerto;
    }
...
class EstadoContext extends antlr4.ParserRuleContext {
	...
	ON_TIME() {
	    return this.getToken(FlightParser.ON_TIME, 0);
	};
...
FlightParser.AeropuertoContext = AeropuertoContext; 
